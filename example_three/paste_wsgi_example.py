...
class ExampleApp(object):
    ...
    # Our routes map URIs to methods of this app, and define how to extract
    # args from requests
    # Complaint: in order to make this REST-ful, you have to plan routes
    # yourself
    ...
    def __call__(self, req):
        '''
        Glue.  A WSGI app is a callable; thus in order to make this object
        an application, we define __call__ to make it callable.  We then ask
        our Mapper to do some routing, and dispatch to the appropriate
        method.  That method must return a webob.Response.
        '''
